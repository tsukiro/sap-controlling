 ...
 */
class Version20180221000339 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE detalle (id INT AUTO_INCREMENT NOT NULL, compra_id INT DEFAULT NULL, tipo INT NOT NULL, cantidad INT NOT NULL, descripcion LONGTEXT NOT NULL, medida VARCHAR(3) NOT NULL, tiempo VARCHAR(1) NOT NULL, valor NUMERIC(10, 2) NOT NULL, INDEX IDX_80397C30F2E704D7 (compra_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pago (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, proveedor_id INT DEFAULT NULL, descripcion LONGTEXT NOT NULL, estado INT NOT NULL, tipo INT NOT NULL, created DATETIME NOT NULL, INDEX IDX_F4DF5F3EDB38439E (usuario_id), INDEX IDX_F4DF5F3ECB305D73 (proveedor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
