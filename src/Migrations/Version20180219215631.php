 ...
 */
class Version20180219215631 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE compra (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, proveedor_id INT DEFAULT NULL, detalle_id INT DEFAULT NULL, descripcion LONGTEXT NOT NULL, created DATETIME NOT NULL, solicitante VARCHAR(255) NOT NULL, tipo INT NOT NULL, estado INT NOT NULL, INDEX IDX_9EC131FFDB38439E (usuario_id), INDEX IDX_9EC131FFCB305D73 (proveedor_id), INDEX IDX_9EC131FF9EA59ED2 (detalle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE oc (id INT AUTO_INCREMENT NOT NULL, numero VARCHAR(255) NOT NULL, created DATETIME NOT NULL, estado INT NOT NULL, observacion LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
